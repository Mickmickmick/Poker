...
namespace Villain
{
    public partial class AI
    {
        ...
        public int GetMove(Dealer Mr_Brown)
        {
            ...
            int small_stack = opponentBet + Mr_Brown.players[0].StackSize < Mr_Brown.OtherPlayer(Mr_Brown.dealer_button).StackSize ? Mr_Brown.dealer_button.StackSize : Mr_Brown.OtherPlayer(Mr_Brown.dealer_button).StackSize;
        ...
        //private List<Card> GenerateCards(Dealer Mr_Brown, Random r)
        //{
        //    if (Mr_Brown.c == null)
        //        return GenerateCards(new List<Card>(2){Mr_Brown.players[1].HoleCards[0], Mr_Brown.players[1].HoleCards[1]}, r);

        //    List<Card> l = new List<Card>(2) { Mr_Brown.players[1].HoleCards[0], Mr_Brown.players[1].HoleCards[1] };
        //    foreach (Card c in Mr_Brown.c)
        //        l.Add(c);
        //    return GenerateCards(l, r);
        //}

        //private List<Card> GenerateCards(List<Card> list, Random r)
        //{
        //    while (list.Count < 9)
        //    {
        //        Card Generated = new Card((CARD_SUIT)suits.GetValue(r.Next(suits.Length)), (CARD_RANK)ranks.GetValue(r.Next(ranks.Length)));
        //        if (!IsThere(list, Generated))
        //            list.Add(Generated);
        //    }
        //    return list;
